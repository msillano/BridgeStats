 ...
 *
 * <br/>STRUTTURA DATI:
 * Si usano 2 codifiche per rappresentare univocamente una mano:<ul>
 *  <li> un array di indici [0..fullSize): setVIX 
 *  <li> un long [0.. getTotHands() ): IndexIXD </ul>
 * La conversione utilizza un algoritmo basato
 * sulle "differenze" (VDFdata): numero di posizioni da superarare per ottenere la carta successiva
 * della mano (ordinata), saltando le eventuali carte asseganate ad altre mani (VIXavailable)
 *
 *
 *  <pre>
 *   IndexIXD -> SetVIX:
...
public class CardSet
        ...
        public CardSet(IGame gioco, int cSize)
                {
                //  devee sistere un gioco ed un mazzo di riferimento
                assert(gioco != null) ;
...
//                assert(XIDdata != -1);
        ...
        * Utility di conversione da distribuzione VDF a numero XID (long).
         ...
         * @param nMazzo numero carte del mazzo (fullSize)
         * @param nMano numero carte della mano (setSize)
         * @param mano array differenze (VDFdata)
         * @return XIDdata long identificativo della mano
         */
